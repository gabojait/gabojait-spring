...
public enum ErrorCode {
    ...
    NICKNAME_FIELD_REQUIRED(BAD_REQUEST, "닉네임은 필수 입력란입니다."),
    GENDER_FIELD_REQUIRED(BAD_REQUEST, "성별은 필수 입력란입니다."),
    IS_SEEKING_TEAM_FIELD_REQUIRED(BAD_REQUEST, "팀 찾기 여부는 필수 입력란입니다."),
    SKILL_ID_FIELD_REQUIRED(BAD_REQUEST, "기술 식별자는 필수 입력란입니다."),
    SKILL_NAME_FIELD_REQUIRED(BAD_REQUEST, "기술명은 필수 입력란입니다."),
    IS_EXPERIENCED_FIELD_REQUIRED(BAD_REQUEST, "경험 여부는 필수 입력란입니다."),
    LEVEL_FIELD_REQUIRED(BAD_REQUEST, "레벨은 필수 입력란입니다."),
    POSITION_FIELD_REQUIRED(BAD_REQUEST, "포지션은 필수 입력란입니다."),
    INSTITUTION_NAME_FIELD_REQUIRED(BAD_REQUEST, "학교명은 필수 입력란입니다."),
    STARTED_DATE_FIELD_REQUIRED(BAD_REQUEST, "시작일은 필수 입력란입니다."),
    ENDED_DATE_FIELD_REQUIRED(BAD_REQUEST, "종료일은 필수 입력란입니다."),
    IS_CURRENT_FIELD_REQUIRED(BAD_REQUEST, "현재 여부는 필수 입력란입니다."),
    EDUCATION_ID_FIELD_REQUIRED(BAD_REQUEST, "학력 식별자는 필수 입력란입니다."),
    CORPORATION_NAME_FIELD_REQUIRED(BAD_REQUEST, "기관명는 필수 입력란입니다."),
    WORK_ID_FIELD_REQUIRED(BAD_REQUEST, "경력 식별자는 필수 입력란입니다."),
    PORTFOLIO_NAME_FIELD_REQUIRED(BAD_REQUEST, "포트폴리오명는 필수 입력란입니다."),
    URL_FIELD_REQUIRED(BAD_REQUEST, "URL은 필수 입력란입니다."),
    PORTFOLIO_ID_FIELD_REQUIRED(BAD_REQUEST, "포트폴리오 식별자는 필수 입력란입니다."),
    PAGE_FROM_FIELD_REQUIRED(BAD_REQUEST, "페이지 시작점은 필수 입력란입니다."),
    PROFILE_ORDER_FIELD_REQUIRED(BAD_REQUEST, "프로필 정렬 기준은 필수 입력란입니다."),
    TEAM_ID_FIELD_REQUIRED(BAD_REQUEST, "팀 식별자는 필수 입력란입니다."),
    PROJECT_NAME_FIELD_REQUIRED(BAD_REQUEST, "프로젝트명는 필수 입력란입니다."),
    PROJECT_DESCRIPTION_FIELD_REQUIRED(BAD_REQUEST, "프로젝트 설명은 필수 입력란입니다."),
    DESIGNER_TOTAL_RECRUIT_CNT_FIELD_REQUIRED(BAD_REQUEST, "디자이너 총 팀원 수는 필수 입력란입니다."),
    BACKEND_TOTAL_RECRUIT_CNT_FIELD_REQUIRED(BAD_REQUEST, "백엔드 개발자 총 팀원 수는 필수 입력란입니다."),
    FRONTEND_TOTAL_RECRUIT_CNT_FIELD_REQUIRED(BAD_REQUEST, "프론트엔드 개발자 총 팀원 수는 필수 입력란입니다."),
    MANAGER_TOTAL_RECRUIT_CNT_FIELD_REQUIRED(BAD_REQUEST, "매니저 총 팀원 수는 필수 입력란입니다."),
    EXPECTATION_FIELD_REQUIRED(BAD_REQUEST, "바라는 점은 필수 입력란입니다."),
    OPEN_CHAT_URL_FIELD_REQUIRED(BAD_REQUEST, "오픈 채팅 URL은 필수 입력란입니다."),
    TEAM_ORDER_FIELD_REQUIRED(BAD_REQUEST, "팀 정렬 기준은 필수 입력란입니다."),
    ...
    ADMIN_NAME_FIELD_REQUIRED(BAD_REQUEST, "아이디는 필수 입력란입니다."),
    LEGAL_NAME_FIELD_REQUIRED(BAD_REQUEST, "실명은 필수 입력란입니다."),
