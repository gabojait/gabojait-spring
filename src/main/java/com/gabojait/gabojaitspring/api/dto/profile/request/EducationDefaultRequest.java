...
@GroupSequence({EducationDefaultRequest.class,
        ValidationSequence.Blank.class,
        ValidationSequence.Size.class,
        ValidationSequence.Format.class})
@ApiModel(value = "학력 기본 요청")
public class EducationDefaultRequest {
    ...
    @Builder
    private EducationDefaultRequest(Long educationId,
    ...
    public boolean equals(Object o) {
        ...
        EducationDefaultRequest that = (EducationDefaultRequest) o;
