...
public class ProfileController {
    ...
    @ApiOperation(value = "프로필 업데이트",
            notes = "<응답 코드>\n" +
                    ...
                    "STARTED_AT_FIELD_REQUIRED || ENDED_AT_FILED_REQUIRED || IS_CURRENT_FIELD_REQUIRED || " +
                    "CORPORATION_NAME_FIELD_REQUIRED || CORPORATION_NAME_LENGTH_INVALID || " +
                    "WORK_DESCRIPTION_LENGTH_INVALID || PORTFOLIO_NAME_FIELD_REQUIRED || " +
                    "PORTFOLIO_NAME_LENGTH_INVALID || PORTFOLIO_URL_FIELD_REQUIRED || " +
                    "PORTFOLIO_URL_LENGTH_INVALID || MEDIA_FIELD_REQUIRED || MEDIA_TYPE_INVALID || " +
                    "EDUCATION_DATE_INVALID || EDUCATION_ENDED_AT_FIELD_REQUIRED || WORK_DATE_INVALID || " +
