...
public class UserSaveReqDto {
    ...
    @NotBlank(message = "비밀번호 재입력을 입력해 주세요.", groups = ValidationSequence.Blank.class)
    private String passwordReEntered;

    @ApiModelProperty(position = 3, required = true, value = "실명", example = "김가보자잇")
    @NotBlank(message = "실명을 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotBlank(message = "닉네임을 입력해 주세요.", groups = ValidationSequence.Blank.class)
