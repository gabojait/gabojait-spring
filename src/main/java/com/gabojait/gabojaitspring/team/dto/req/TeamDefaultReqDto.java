...
public class TeamDefaultReqDto {
    ...
    @NotBlank(message = "프로젝트명을 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotBlank(message = "프로젝트 설명을 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotNull(message = "디자이너 총 팀원 수를 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotNull(message = "백엔드 개발자 총 팀원 수를 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotNull(message = "프론트엔드 개발자 총 팀원 수를 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotNull(message = "매니저 총 팀원 수를 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotBlank(message = "바라는 점을 입력해 주세요.", groups = ValidationSequence.Blank.class)
    ...
    @NotBlank(message = "오픈 채팅 링크를 입력해 주세요.", groups = ValidationSequence.Blank.class)
    @Size(min = 25, max = 100, message = "오픈 채팅 링크는 25~100자만 가능합니다.", groups = ValidationSequence.Size.class)
    @Pattern(regexp = "^https\\:\\/\\/open\\.kakao\\.com\\/.+$", message = "오픈 채팅 링크는 카카오 오픈 채팅 URL 형식만 가능합니다.",
