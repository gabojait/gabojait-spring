...
@Getter
@NoArgsConstructor
@GroupSequence({TeamUserFavoriteDefaultReqDto.class, ValidationSequence.NotNull.class})
@ApiModel(value = "Team 유저 찜하기 기본 요청")
public class TeamUserFavoriteDefaultReqDto {
