...
public class ProfileDefaultResponseDto {
    ...
    @ApiModelProperty(position = 11, required = true, value = "현재 프로젝트")
    private ProjectAbstractResponseDto currentProject;
    ...
    public ProfileDefaultResponseDto(Profile profile) {
        ...
        if (profile.getCurrentProject() != null)
            this.currentProject = new ProjectAbstractResponseDto(profile.getCurrentProject());
        else
