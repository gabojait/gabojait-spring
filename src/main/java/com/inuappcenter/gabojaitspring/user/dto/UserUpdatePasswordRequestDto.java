...
public class UserUpdatePasswordRequestDto {
    ...
    @ApiModelProperty(position = 1, required = true, value = "현재 비밀번호", example = "password1!")
    @NotBlank(message = "모든 필수 정보를 입력해주세요", groups = ValidationSequence.NotBlank.class)
    private String currentPassword;

    @ApiModelProperty(position = 2, required = true, value = "새 비밀번호", example = "password2!")
    @NotBlank(message = "모든 필수 정보를 입력해주세요", groups = ValidationSequence.NotBlank.class)
    ...
    @ApiModelProperty(position = 3, required = true, value = "새 비밀번호 재입력", example = "password2!")
    @NotBlank(message = "모든 필수 정보를 입력해주세요", groups = ValidationSequence.NotBlank.class)
