...
public class UserService {
    ...
    public UserDefaultResponseDto save(UserSaveRequestDto request) {
        log.info("IN PROGRESS | 유저 저장 At " + LocalDateTime.now() + " | " + request.toString());
        ...
        try {
            ...
            log.info("COMPLETE | 유저 저장 At " + LocalDateTime.now() + " | " + insertedUser);
    ...
    public User assignAsUser(User user) {
        log.info("IN PROGRESS | 유저 역할 부여 At " + LocalDateTime.now() + " | " + user.toString());
        user.addRole("USER");
        log.info("COMPLETE | 유저 역할 부여 At " + LocalDateTime.now() + " | " + user);
        return user;
    }
    ...
    public void findForgotUsernameByEmail(String email) {
        log.info("IN PROGRESS | 유저 이메일로 조회 At " + LocalDateTime.now() + " | " + email);
        ...
        userRepository.findByContact(contact.getEmail())
                .ifPresentOrElse((user) -> {
                    ...
                    log.info("COMPLETE | 유저 이메일로 조회 At " + LocalDateTime.now() + " | " + user);
                }, () -> {
                    throw new UnauthorizedException("유저 정보가 존재하지 않습니다");
                });
    }
    ...
    public void deleteAll() {
        try {
            log.info("IN PROGRESS | 유저 전체 삭제 At " + LocalDateTime.now());
